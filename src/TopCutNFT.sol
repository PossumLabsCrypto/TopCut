 ...
 * Affiliate rewards accrue in Affiliate Points (AP) in the TopCutVault
 * AP can be burned for ETH from the TopCutVault
 * All predictions must be submitted with a valid affiliateID
